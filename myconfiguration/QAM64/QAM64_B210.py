...
class QAM64_B210(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM64_B210", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM64_B210")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QAM64_B210")
        ...
        self.x = x = 0.9393
        self.variable_adaptive_algorithm_1 = variable_adaptive_algorithm_1 = digital.adaptive_algorithm_cma( digital.qam_constellation(64,True,digital.mod_codes.GRAY_CODE,True).base(), eq_gain, 2).base()
        ...
        self._x_range = qtgui.Range(0, 1, 0.001, 0.9393, 200)
        ...
        self._gain_tx_range = qtgui.Range(0, 74, 1, 45, 200)
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._freq_offset_range = qtgui.Range(-0.01, 0.01, 0.0001, 0, 200)
        ...
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._delay_range = qtgui.Range(0, 200, 1, 174, 200)
        ...
        self._eq_gain_range = qtgui.Range(0.0, 0.001, 0.0001, 0.001, 200)
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, 2, variable_adaptive_algorithm_1, True, [ ], 'corr_est')
        self.digital_diff_encoder_bb_0 = digital.diff_encoder_bb(64, digital.DIFF_DIFFERENTIAL)
        self.digital_diff_decoder_bb_0_0 = digital.diff_decoder_bb(64, digital.DIFF_DIFFERENTIAL)
        ...
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_cc(0.83)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(1.19)
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.digital_linear_equalizer_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.digital_constellation_receiver_cb_0, 0))
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.blocks_multiply_const_vxx_1_0, 0))
...
def main(top_block_cls=QAM64_B210, options=None):
