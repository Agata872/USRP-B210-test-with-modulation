...
class rx_ofdm_64(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "rx_ofdm_64")
        ...
        self._gain_range = qtgui.Range(0, 100, 1, 40, 200)
        ...
        self.digital_ofdm_sync_sc_cfb_0 = digital.ofdm_sync_sc_cfb(fft_len, (fft_len//4), True, 0.9)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'D:\\Documents\\Pycharm_Files\\USRP-B210-test-with-modulation\\Updated_config\\OFDM\\rx.bin', False)
...
def main(top_block_cls=rx_ofdm_64, options=None):
