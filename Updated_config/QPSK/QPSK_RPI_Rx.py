...
class QPSK_RPI_Rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK_RPI_Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK_RPI_Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_RPI_Rx")
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.zeromq_push_msg_sink_1 = zeromq.push_msg_sink('tcp://<192.108.2.61>:5556', 100, True)
...
def main(top_block_cls=QPSK_RPI_Rx, options=None):
