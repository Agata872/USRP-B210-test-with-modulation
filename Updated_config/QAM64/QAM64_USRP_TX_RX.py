...
class QAM64_USRP_TX_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.x = x = 0.94
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_cma( digital.qam_constellation(64, True,digital.mod_codes.GRAY_CODE,True).base(), eq_gain, 1).base()
        ...
        self._x_range = qtgui.Range(0, 1, 0.001, 0.94, 200)
        ...
        self._timing_loop_bw_range = qtgui.Range(0.0, 0.1, 0.001, 6.28/400, 200)
        ...
        self._phase_bw_range = qtgui.Range(0.0, 0.1, 0.01, 6.28/800, 200)
        ...
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._delay_range = qtgui.Range(0, 200, 1, 48, 200)
        ...
        self._eq_gain_range = qtgui.Range(0.0, 0.01, 0.0001, 0.000000001, 200)
