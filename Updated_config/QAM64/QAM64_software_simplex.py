...
class QAM64_software_simplex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(0.83666)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc2_xx_0, 0), (self.digital_constellation_receiver_cb_0, 0))
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.analog_agc2_xx_0, 0))
